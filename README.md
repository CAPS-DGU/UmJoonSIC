...
- 이 저장소에는 **jurem/SicTools**의 일부 코드 및 아이디어가 **Git subtree** 형태로 포함될 수 있습니다. 해당 부분은 **원저작권자 및 라이선스 고지( BSD-2-Clause )를 그대로 보존**하며, 원본 라이선스 전문과 저작권 표기는 저장소 내 제3자 고지(예: `THIRD_PARTY_NOTICES` 또는 `third_party/`)에 포함합니다.
...
- **개발 지도:** 동국대학교 컴퓨터·AI학부 교수 **정준호**, **한인**  
- **개발 총괄:**  
  - 컴퓨터공학과 **20학번 정상원**  
  - 약학과 **23학번 원종인**  
  - 컴퓨터·AI학부 **24학번 송윤석**  
...
오류 제보는 자유롭게 **Issues**로 등록해 주세요. **BSD-2-Clause** 라이선스를 준수하는 범위에서 자유로운 이용과 파생 작업을 환영합니다. 함께해 주신 스터디원들과 **정준호 교수님**께 깊이 감사드립니다.
