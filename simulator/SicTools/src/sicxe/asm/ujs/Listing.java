...
import sicxe.asm.ujs.OpcodeLUT;
import sicxe.asm.ujs.Relocations;
import sicxe.asm.visitors.WriteVisitor;
...
public class Listing extends WriteVisitor {
    ...
    public void relocate(sicxe.asm.ujs.Relocations relocations) {
        ...
        for (sicxe.asm.ujs.Relocations.ControlSectionInfo csi : relocations.getControlSections()) {
        ...
        final List<sicxe.asm.ujs.Relocations.PatchInfo> patches =
